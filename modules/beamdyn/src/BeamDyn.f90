...
!!output of m%qp%uuu(1:3,idx_qp,nelem)
!do i=1,3               !DOF
!tmpint=3000+100+10+i
!write(tmpint,*) t,p%uu0(i,:,1)+m%qp%uuu(i,:,1)
!enddo
!-----------------------------------------------------
!ADP: debugging end
...
SUBROUTINE BD_InternalForceMomentIGE( x, p, m )
   ...
   REAL(BDKi)                    :: NodePos(3)
real(BDKi) :: weightRange     ! Variable for test setup.  to be moved into params later
