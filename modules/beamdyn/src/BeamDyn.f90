...
subroutine SetParameters(InitInp, InputFileData, p, ErrStat, ErrMsg)
   ...
   CALL AllocAry(p%QPtWDeltaEta,p%nqp,'p%QPtDeltaEta array',ErrStat2,ErrMsg2) ; CALL SetErrStat( ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName )
...
!NOTE: the FE nodes are not yet calculated by this method.
   ENDIF
